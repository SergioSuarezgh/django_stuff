...
def import_data(request):
    if request.method == 'POST':
        file_path = request.FILES.get('file_path') # le pasamnos el nombre del input type file
        model_name = request.POST.get('model_name') # Esto recoge el valor del form
        ...
        # handle the task import data task here (with celery)
